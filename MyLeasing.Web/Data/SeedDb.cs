...
namespace MyLeasing.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("1010", "David", "Cabrera", "ing.dacabrera@gmail.com", "849 855 9380", "Calle Luna Calle Sol", "Manager");
            var owner = await CheckUserAsync("2020", "David", "Cabrera", "Cabreram.07@hotmail.com", "829 344 5160", "Calle Luna Calle Sol", "Owner");
        ...
        private async Task CheckContractsAsync()
        {
            ...
            if (!_context.Contracts.Any())
            {
                _context.Contracts.Add(new Contract
                {
                    ...
                    "elit. Mauris nec iaculis ex. Nullam gravida nunc eleifend, " +
                    "placerat tellus a, eleifend metus. Phasellus id suscipit " +
                    "magna. Orci varius natoque penatibus et magnis dis parturient" +
                    " montes, nascetur ridiculus mus. Nullam volutpat ultrices ex, " +
                    "sed cursus sem tincidunt ut. Nullam metus lorem, convallis quis " +
